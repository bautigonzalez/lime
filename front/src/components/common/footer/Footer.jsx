        ...
        <div className="row">
            ...
            <div className="col-4">
                <div id="primerfila" className="container">
                    ...
                    <span><img className="red" src="https://lh3.googleusercontent.com/proxy/RfYmb3IyuYKV0b2rmeWHqgI7BSuHg2kbFbqT4FjiveOB-m6a7QQJZytFYZUOo2Jq7SMiy1zQuszG66O_b309S9gpZ1SnAisYJMteVFKt6oXsKbOho0w"/></span>
                </div>
            </div>
            <div className="col-4"></div>
        </div>
          <div className="row">
            ...
            <div className="col-8">
                <div className="container">
                    <span className="primero">Obtener Lime App</span>
                    <span>Ayuda</span>
                    <span>Índice del sitio</span>
                    <span>LimePro</span>
